...
1. **Infrastructure as Code (IaC)**: MOSIP RDI leverages tools like **Terraform** for declarative, version-controlled infrastructure provisioning. This ensures repeatable, automated deployments and minimizes manual intervention.
...
<figure><img src="../../docs/.gitbook/assets/deployment_architecture.png" alt=""><figcaption></figcaption></figure>

#### Key Resources

You can refer to the following key resources to get started with MOSIP Rapid Deployment, Currently the links takes you to repo READMEs as this is the the first beta release of MOSIP RDI and we are working to bring all the relevant content to this published documentation site as well.
...
For additional guidance, refer to the [Documentation](#documentation) section at the end of this document for links to checklists, setup guides, and troubleshooting resources.
...
# Documentation
- [**MOSIP Rapid Deployment Documentation**:](https://github.com/mosip/infra/blob/master/README.md)
