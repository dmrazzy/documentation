...
MOSIP can integrate with Civil Registration and Vital Statistics (CRVS) systems to create a unified digital identity ecosystem that spans an individual's entire life cycle. 
...
### What is a CRVS System and What is MOSIP (Foundational Identity Platform)?

Civil registration systems record vital life events such as births, deaths, marriages, and divorces. 
Meanwhile, national ID systems provide legal and verifiable identities. 


When these systems operate in isolation, it leads to administrative inefficiencies, fragmented data, and challenges in service access.
...
## Example scopes of integration include

[Refer to scope topic](link)
