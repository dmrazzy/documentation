...
For detailed technical specifications, API documentation, and schema definitions, please refer to the subsequent section [here](technical-details.md). For details on configuration changes, refer [here](../../../../../../id-lifecycle-management/identity-issuance/registration-processor/deploy/configurations-details.md).
