...
* [Registration Processor Configurations Details](../../configurations-and-operations/prerequisites/configurations-details.md) - Discover the technical configurations including Camel routes (`CRVS_fraud_birth`) and packet processing workflows that enable both deactivation and reactivation requests to be routed correctly for manual review.
