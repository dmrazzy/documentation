...
| **Feature**                                                                                                                                                               | **Description**                                                                                                                                                                                                                                                     |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Partner Management Services](https://github.com/mosip/partner-management-services/tree/release-1.2.2.x)                                                                  | Partner Management Services                                                                                                                                                                                                                                         |
| [Partner Management System](https://github.com/mosip/partner-management-portal/tree/release-1.2.2.x)                                                                      | For code and implementation of Partner Management System (revamp)                                                                                                                                                                                                   |
