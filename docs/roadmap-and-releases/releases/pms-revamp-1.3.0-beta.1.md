...
**For Individual Certificates (Root CA / Intermediate CA / Partner Certificate):**
* 30 days before expiry
* 15 days before expiry
* Daily reminders from 10 days prior until expiry date

**Weekly Summary Notifications (Partner Admins only):**
* Sent every 7 days
...
**d) Notification Retention Policy:**
...
| Module/ Repo          | Compatible versions  |
| --------------------- | -------------------------------------------------------------------------|
