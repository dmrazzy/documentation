...
| JIRA | Description |
|------|-------------|
| MOSIP-41858 | Resident module test cases related to revoked VID, invalid inputs, and language codes are failing |
| MOSIP-41859 | Resident test cases related to phone channel operations, VID generation, auth history, and lock/unlock features are failing |

### **Repository Released**

| Repository | Tag Released |
|------------|--------------|
| resident-services | v1.2.1.2 |


### **Documentation**

- [Documentation for Resident Service API Test Rig]()
