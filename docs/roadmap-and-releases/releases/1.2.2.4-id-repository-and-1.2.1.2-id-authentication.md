...
Refer [here ](../../id-lifecycle-management/identity-issuance/id-repository/README.md)to know more about features of ID Repository.
...
### 1.2.2.4 ID Repository

- Correction of critical IDRepo update failure during registrant transitions (e.g., Child → Adult).
- Initiation of Docker base image migration to Eclipse Temurin JRE for improved security and maintainability.

### 1.2.1.2 ID Authentication
...
- Resolution of PSUT token inconsistencies across [UIN](../../id-lifecycle-management/identity-management/identifiers.md#uin), [VID](../../id-lifecycle-management/identity-management/identifiers.md#vid), and [Handle](../../id-lifecycle-management/identity-issuance/id-repository/custom-handle.md#what-is-a-handle).
-->