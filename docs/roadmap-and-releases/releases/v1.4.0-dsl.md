...
1. [MOSIP-43461](https://mosip.atlassian.net/browse/MOSIP-43461) : **Separate Error Report for DSL Test Rig**: Introduced a dedicated **Failed & Skipped report for DSL executions**, similar to the API Test Rig. This allows users to quickly review failing scenarios without downloading the complete execution report, improving usability when only a small number of failures occur.
2. [MOSIP-44449](https://mosip.atlassian.net/browse/MOSIP-44449): **Bug ID Integration in DSL Reports**: Added support to include **Bug IDs for known issues directly in DSL reports**, with links to the corresponding Jira tickets. This improves traceability and helps users quickly identify known issues associated with scenario failures.
3. &#x20;[MOSIP-44180](https://mosip.atlassian.net/browse/MOSIP-44180): **Notification Capture in DSL Scenarios**: Implemented a new **DSL step to capture and log system notifications generated during scenario execution**. Notifications such as UIN creation, VID generation, and authentication results are now recorded in the DSL/TestNG reports, improving visibility and debugging capabilities.
4. [MOSIP-44268](https://mosip.atlassian.net/browse/MOSIP-44268): **Biometric Update Scenario Stabilization**: Investigated and resolved failures occurring in **Update Biometric scenarios within the DSL framework**. Root causes were analysed and fixes were implemented to ensure stable and reliable execution of biometric update workflows.
5. [MOSIP-35453](https://mosip.atlassian.net/browse/MOSIP-35453): **Packet Creator Log Traceability**: Enhanced DSL reporting by improving **traceability of Packet Creator interactions**. The framework now captures execution-related details to better correlate orchestrator runs with Packet Creator activities, improving debugging and execution analysis for distributed DSL runs.
