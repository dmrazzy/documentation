...
We’re excited to announce the release of **Registration Processor v1.2.1.0**, designed to make external system integration easier and more efficient than ever. This version introduces **support for packet creation from external sources**, empowering any external system to integrate seamlessly with MOSIP’s registration ecosystem.

**What’s new?**

* A new API was added to the **packet manager module** to trigger packet processing
* Support for **packet creation from external systems** by leveraging the existing **create packet API**

#### **Major Highlights** <a href="#major-highlights" id="major-highlights"></a>

1. **New API in Packet Manager Module:**\
...
| **Jira Issue**                                                | **Summary**                                                                |
| ------------------------------------------------------------- | -------------------------------------------------------------------------- |
| [MOSIP-40982](https://mosip.atlassian.net/browse/MOSIP-40982) | Credential request is not getting generated for VID during Update UIN flow |
