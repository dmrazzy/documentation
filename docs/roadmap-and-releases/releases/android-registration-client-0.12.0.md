...
Version 0.12.0 of the Android Registration Client is a beta release, featuring functionalities such as Forgot Password, PRID QR code scan, Lost UIN, Reset password, and Match SDK.
