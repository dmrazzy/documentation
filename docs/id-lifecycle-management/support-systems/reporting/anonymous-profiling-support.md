...
![Registration processor camel routes configuration](/broken/files/TdsNm7OZFDDKWLVWnuZ6)
...
![Anonymous profile table created in Pre-registration schema](/broken/files/BFKXHxwBguxHnQrXxMY8)

Below is the image for the Anonymous profile table created in the Registration processor schema

![Anonymous profile table created in Registration processor schema](/broken/files/6M9OAgsLJUFyBMyjxPhE)
...
![Anonymous profile table created in ID repository schema](/broken/files/yoj00OmfLkqxSlpsFPC1)
...
![Anonymous profile table created in IDA schema](/broken/files/o3bypYnpc5mu799igYxC)
