...
<figure><img src="../../../../.gitbook/assets/temp-ftm-chip-provider-image1.png"</figure>

2.  Within Root CA tab - click on **Upload Trust Certificate** button on
    the top-right of the screen.

<figure><img src="../../../../.gitbook/assets/temp-ftm-chip-provider-image2.png"</figure>

3.  Select the Partner Domain, (FTM)

<figure><img src="../../../../.gitbook/assets/temp-ftm-chip-provider-image3.png"</figure>

4.  Choose the **Root CA Certificate** to upload (only files with
    extensions as .cer or .pem).

<figure><img src="../../../../.gitbook/assets/temp-ftm-chip-provider-image4.png"</figure><figure><img src="../../../../.gitbook/assets/temp-ftm-chip-provider-image5.png"</figure>
...
<figure><img src="../../../../.gitbook/assets/temp-ftm-chip-provider-image6.png"</figure>
...
<figure><img src="../../../../.gitbook/assets/temp-ftm-chip-provider-image7.png"</figure>
...
<figure><img src="../../../../.gitbook/assets/temp-ftm-chip-provider-image8.png"</figure>
...
<figure><img src="../../../../.gitbook/assets/temp-ftm-chip-provider-image9.png"</figure>
...
<figure><img src="../../../../.gitbook/assets/temp-ftm-chip-provider-image10.png"</figure>

2.  Click on **Partner Certificate** option, Click on the **Upload**
    button to upload the partner certificate signed by CA.

<figure><img src="../../../../.gitbook/assets/temp-ftm-chip-provider-image11.png"</figure>

3.  Select the CA signed partner certificate from local system by
    tapping on the upload section (blue area).

<figure><img src="../../../../.gitbook/assets/temp-ftm-chip-provider-image12.png"</figure>

4.  The required certificate is selected from the local system.

<figure><img src="../../../../.gitbook/assets/temp-ftm-chip-provider-image13.png"</figure>

5.  Certificate is successfully fetched from local system.

<figure><img src="../../../../.gitbook/assets/temp-ftm-chip-provider-image14.png"</figure>

6.  Click on **Submit**, Partner Certificate is uploaded successfully.

<figure><img src="../../../../.gitbook/assets/temp-ftm-chip-provider-image15.png"</figure>

7.  On closing the popup, The user can view the uploaded certificate
    details in the form of a list view.

<figure><img src="../../../../.gitbook/assets/temp-ftm-chip-provider-image16.png"</figure>
...
<figure><img src="../../../../.gitbook/assets/temp-ftm-chip-provider-image17.png"</figure>

Success Message is displayed on successful download of Originally
uploaded certificate/ MOSIP Signed Certificate.

<figure><img src="../../../../.gitbook/assets/temp-ftm-chip-provider-image18.png"</figure>
...
<figure><img src="../../../../.gitbook/assets/temp-ftm-chip-provider-image19.png"</figure>
...
<figure><img src="../../../../.gitbook/assets/temp-ftm-chip-provider-image20.png"</figure>
...
<figure><img src="../../../../.gitbook/assets/temp-ftm-chip-provider-image21.png"</figure>

The partner is expected to enter the make and model of FTM Chip and
submit the details.

<figure><img src="../../../../.gitbook/assets/temp-ftm-chip-provider-image22.png"</figure>
...
<figure><img src="../../../../.gitbook/assets/temp-ftm-chip-provider-image23.png"</figure>

The partner clicks on the Upload section to select the FTM Chip
Certificate from local system.

<figure><img src="../../../../.gitbook/assets/temp-ftm-chip-provider-image24.png"</figure>

<figure><img src="../../../../.gitbook/assets/temp-ftm-chip-provider-image25.png"</figure>

After selection, the uploaded certificate is displayed on screen which
the partner has to submit.

<figure><img src="../../../../.gitbook/assets/temp-ftm-chip-provider-image26.png"</figure>

A success message on successful submission is displayed on the screen.

<figure><img src="../../../../.gitbook/assets/temp-ftm-chip-provider-image27.png"</figure>
...
<figure><img src="../../../../.gitbook/assets/temp-ftm-chip-provider-image28.png"</figure>
...
<figure><img src="../../../../.gitbook/assets/temp-ftm-chip-provider-image29.png"</figure>

To upload the FTM Chip certificate, select the Manage Certificate option
from action menu.

<figure><img src="../../../../.gitbook/assets/temp-ftm-chip-provider-image30.png"</figure>
...
<figure><img src="../../../../.gitbook/assets/temp-ftm-chip-provider-image31.png"</figure><figure><img src="../../../../.gitbook/assets/temp-ftm-chip-provider-image32.png"</figure><figure><img src="../../../../.gitbook/assets/temp-ftm-chip-provider-image33.png"</figure>
...
<figure><img src="../../../../.gitbook/assets/temp-ftm-chip-provider-image34.png"</figure>
...
<figure><img src="../../../../.gitbook/assets/temp-ftm-chip-provider-image35.png"</figure>

On clicking the action menu of the respective FTM Chip record, an option
'Approve/ Reject' is provided.

<figure><img src="../../../../.gitbook/assets/temp-ftm-chip-provider-image36.png"</figure>

A popup window appears for the admin to take appropriate action-
Approve / Reject and select the respective button.

<figure><img src="../../../../.gitbook/assets/temp-ftm-chip-provider-image37.png"</figure>
...
<figure><img src="../../../../.gitbook/assets/temp-ftm-chip-provider-image38.png"</figure>
...
<figure><img src="../../../../.gitbook/assets/temp-ftm-chip-provider-image39.png"</figure>

To re-upload certificate after expiry or otherwise, click on Re-Upload
button.

<figure><img src="../../../../.gitbook/assets/temp-ftm-chip-provider-image40.png"</figure>

Follow the same steps as upload flow to perform the reupload
functionality.

<figure><img src="../../../../.gitbook/assets/temp-ftm-chip-provider-image41.png"</figure>

<figure><img src="../../../../.gitbook/assets/temp-ftm-chip-provider-image42.png"</figure>
...
<figure><img src="../../../../.gitbook/assets/temp-ftm-chip-provider-image43.png"</figure>

Every Approved FTM Chip record has a download option provided to
download the FTM Chip certificate at any given time.

<figure><img src="../../../../.gitbook/assets/temp-ftm-chip-provider-image44.png"</figure>

on click of download button, a success message is displayed on the
screen.

<figure><img src="../../../../.gitbook/assets/temp-ftm-chip-provider-image45.png"</figure>
...
<figure><img src="../../../../.gitbook/assets/temp-ftm-chip-provider-image46.png"</figure>

On clicking 'Deactivate', a popup window appears seeking for
confirmation and appropriate info text is displayed.

<figure><img src="../../../../.gitbook/assets/temp-ftm-chip-provider-image47.png"</figure>

on deactivation , the status changes to 'Deactivated' status.

<figure><img src="../../../../.gitbook/assets/temp-ftm-chip-provider-image48.png"</figure>
