...
* Please ensure to review the [Guidelines ](169-qr-code-specification.md#guidelines)and important note(s) below with respect to standard attributes and credential status.
...
#### <mark style="color:blue;">Note on Status of Credential (CWT)</mark>
